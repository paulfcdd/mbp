...
class DashboardController extends AbstractController
{
    ...
    public function __construct(Yaml $yaml, EntityManagerInterface $entityManager, SluggerInterface $slugger, ImageProcessor $imageProcessor, LoggerInterface $logger, CurrencyConverter $currencyConverter)
    {
