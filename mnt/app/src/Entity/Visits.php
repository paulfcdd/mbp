...
class Visits
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=BlackList::class, mappedBy="visitor")
     */
    private $blackList;

    /**
     * @ORM\OneToMany(targetEntity=WhiteList::class, mappedBy="visitor")
     */
    private $whiteList;
    ...
    /**
     * @ORM\Column(type="string", length=255, columnDefinition="ENUM('morning', 'afternoon', 'evening', 'night')")
     */
    private $timesOfDay;
