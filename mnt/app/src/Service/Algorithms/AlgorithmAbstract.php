...
abstract class AlgorithmAbstract implements IAlgorithm
{
     ...
     * @param Collection|News[] $lowItems Элемент выбранные дополнительно по getRandomLowNews|getRandomLowNewsForCategory
    ...
    {
        $this->impressionsNews = $impressionsNews ? $impressionsNews : 1000;
    ...
    {
        $this->impressionsTeaser = $impressionsTeaser ? $impressionsTeaser : 1000;
